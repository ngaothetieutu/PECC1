    ...
    public partial class ProfileModelFactory : IProfileModelFactory
    {
        ...
        public virtual ProfileInfoModel PrepareProfileInfoModel(Customer customer)
        {
            ...
            if (_customerSettings.ShowCustomersLocation)
            {
                ...
                var countryId = _genericAttributeService.GetAttribute<int>(customer, GSCustomerDefaults.CountryIdAttribute);
            ...
            if (_forumSettings.ForumsEnabled && _forumSettings.ShowCustomersPostCount)
            {
                ...
                totalPosts = _genericAttributeService.GetAttribute<int>(customer, GSCustomerDefaults.ForumPostCountAttribute);
            }
            ...
            {
                var dob = _genericAttributeService.GetAttribute<DateTime?>(customer, GSCustomerDefaults.DateOfBirthAttribute);
                if (dob.HasValue)
                {
