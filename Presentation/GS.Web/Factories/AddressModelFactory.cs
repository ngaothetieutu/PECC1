    ...
    public partial class AddressModelFactory : IAddressModelFactory
    {
            ...
            string overrideAttributesXml = "")
        {
            ...
            if (address == null && prePopulateWithCustomerFields)
            {
                ...
                model.Address1 = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.StreetAddressAttribute);
                model.Address2 = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.StreetAddress2Attribute);
                ...
                model.PhoneNumber = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.PhoneAttribute);
                model.FaxNumber = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.FaxAttribute);
            }
