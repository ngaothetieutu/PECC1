...
namespace GS.Web.Areas.Admin.Models.Settings
{
    ...
    /// </summary>
    public partial class ForumSettingsModel : BaseGSModel, ISettingsModel
    {
        #region Properties

        public int ActiveStoreScopeConfiguration { get; set; }

        [GSResourceDisplayName("Admin.Configuration.Settings.Forums.ForumsEnabled")]
        public bool ForumsEnabled { get; set; }
        public bool ForumsEnabled_OverrideForStore { get; set; }

        [GSResourceDisplayName("Admin.Configuration.Settings.Forums.RelativeDateTimeFormattingEnabled")]
        ...
        [GSResourceDisplayName("Admin.Configuration.Settings.Forums.TopicsPageSize")]
        public int TopicsPageSize { get; set; }
        public bool TopicsPageSize_OverrideForStore { get; set; }

        [GSResourceDisplayName("Admin.Configuration.Settings.Forums.PostsPageSize")]
        public int PostsPageSize { get; set; }
        public bool PostsPageSize_OverrideForStore { get; set; }

        [GSResourceDisplayName("Admin.Configuration.Settings.Forums.ForumEditor")]
