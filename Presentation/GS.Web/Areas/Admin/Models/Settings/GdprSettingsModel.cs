...
namespace GS.Web.Areas.Admin.Models.Settings
{
    ...
    /// </summary>
    public partial class GdprSettingsModel : BaseGSModel, ISettingsModel
    {
        #region Ctor
        ...
        [GSResourceDisplayName("Admin.Configuration.Settings.Gdpr.GdprEnabled")]
        public bool GdprEnabled { get; set; }
        public bool GdprEnabled_OverrideForStore { get; set; }

        [GSResourceDisplayName("Admin.Configuration.Settings.Gdpr.LogPrivacyPolicyConsent")]
        public bool LogPrivacyPolicyConsent { get; set; }
        public bool LogPrivacyPolicyConsent_OverrideForStore { get; set; }

        [GSResourceDisplayName("Admin.Configuration.Settings.Gdpr.LogNewsletterConsent")]
