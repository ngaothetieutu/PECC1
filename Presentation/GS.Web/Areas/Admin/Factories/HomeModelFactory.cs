...
using GS.Web.Areas.Admin.Infrastructure.Cache;
...
namespace GS.Web.Areas.Admin.Factories
{
    ...
    public partial class HomeModelFactory : IHomeModelFactory
    {
        ...
        public virtual GSCommerceNewsModel PrepareGSCommerceNewsModel()
        {
            var model = new GSCommerceNewsModel
            {
            ...
            for (var i = 0; i < rssData.Items.Count; i++)
            {
                ...
                var newsItem = new GSCommerceNewsDetailsModel
                {
