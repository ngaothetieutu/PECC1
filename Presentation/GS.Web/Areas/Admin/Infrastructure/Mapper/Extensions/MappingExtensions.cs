...
namespace GS.Web.Areas.Admin.Infrastructure.Mapper.Extensions
{
    ...
    public static class MappingExtensions
    {
        ...
        /// <returns>Mapped model</returns>
        public static TModel ToSettingsModel<TModel>(this ISettings settings) where TModel : BaseGSModel, ISettingsModel
        {
            if (settings == null)
        ...
        public static TSettings ToSettings<TSettings, TModel>(this TModel model, TSettings settings)
            where TSettings : class, ISettings where TModel : BaseGSModel, ISettingsModel
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
