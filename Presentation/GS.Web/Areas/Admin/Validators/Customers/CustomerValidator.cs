...
{
    public partial class CustomerValidator : BaseGSValidator<CustomerModel>
    {
        ...
        private bool IsRegisteredCustomerRoleChecked(CustomerModel model, ICustomerService customerService)
        {
            ...
            var isInRegisteredRole = newCustomerRoles.FirstOrDefault(cr => cr.SystemName == GSCustomerDefaults.RegisteredRoleName) != null;
