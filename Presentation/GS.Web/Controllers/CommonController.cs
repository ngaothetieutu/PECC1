...
namespace GS.Web.Controllers
{
    public partial class CommonController : BasePublicController
    {
        ...
        public virtual IActionResult EuCookieLawAccept()
        {
            ...
            //save setting
            _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, GSCustomerDefaults.EuCookieLawAcceptedAttribute, true, _storeContext.CurrentStore.Id);
