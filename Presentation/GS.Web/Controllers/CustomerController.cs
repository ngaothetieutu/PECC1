...
{
    public partial class CustomerController : BaseWorksController
    {
        #region Fields
        ...
        protected virtual string ValidateCustomerRoles(IList<CustomerRole> customerRoles)
        {
            ...
            var isInGuestsRole = customerRoles.FirstOrDefault(cr => cr.SystemName == GSCustomerDefaults.GuestsRoleName) != null;
            var isInRegisteredRole = customerRoles.FirstOrDefault(cr => cr.SystemName == GSCustomerDefaults.RegisteredRoleName) != null;
        ...
        {
            var customers = _customerService.GetAllCustomers(customerRoleIds: new[] { _customerService.GetCustomerRoleBySystemName(GSCustomerDefaults.AdministratorsRoleName).Id });
        ...
        public virtual IActionResult Logout()
        {
            if (_workContext.OriginalCustomerIfImpersonated != null)
            {
                ...
                _genericAttributeService
                    .SaveAttribute<int?>(_workContext.OriginalCustomerIfImpersonated, GSCustomerDefaults.ImpersonatedCustomerIdAttribute, null);
        ...
        public virtual IActionResult PasswordRecoverySend(PasswordRecoveryModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (customer != null && customer.Active && !customer.Deleted)
                {
                    ...
                    _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.PasswordRecoveryTokenAttribute,
                        passwordRecoveryToken.ToString());
                    DateTime? generatedDateTime = DateTime.UtcNow;
                    _genericAttributeService.SaveAttribute(customer,
                        GSCustomerDefaults.PasswordRecoveryTokenDateGeneratedAttribute, generatedDateTime);
        ...
        public virtual IActionResult PasswordRecoveryConfirm(string token, string email)
        {
            ...
            if (string.IsNullOrEmpty(_genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.PasswordRecoveryTokenAttribute)))
            {
        ...
        public virtual IActionResult Register(RegisterModel model, string returnUrl, bool captchaValid)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (registrationResult.Success)
                {
                    ...
                    {
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.TimeZoneIdAttribute, model.TimeZoneId);
                    }
                   
                    //form fields
                    if (_customerSettings.GenderEnabled)
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.GenderAttribute, model.Gender);
                    _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.FirstNameAttribute, model.FirstName);
                    _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.LastNameAttribute, model.LastName);
                    if (_customerSettings.DateOfBirthEnabled)
                    {
                        var dateOfBirth = model.ParseDateOfBirth();
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.DateOfBirthAttribute, dateOfBirth);
                    }
                    if (_customerSettings.CompanyEnabled)
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.CompanyAttribute, model.Company);
                    if (_customerSettings.StreetAddressEnabled)
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.StreetAddressAttribute, model.StreetAddress);
                    if (_customerSettings.StreetAddress2Enabled)
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.StreetAddress2Attribute, model.StreetAddress2);
                    if (_customerSettings.ZipPostalCodeEnabled)
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.ZipPostalCodeAttribute, model.ZipPostalCode);
                    if (_customerSettings.CityEnabled)
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.CityAttribute, model.City);
                    if (_customerSettings.CountyEnabled)
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.CountyAttribute, model.County);
                    if (_customerSettings.CountryEnabled)
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.CountryIdAttribute, model.CountryId);
                    if (_customerSettings.CountryEnabled && _customerSettings.StateProvinceEnabled)
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.StateProvinceIdAttribute,
                            model.StateProvinceId);
                    if (_customerSettings.PhoneEnabled)
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.PhoneAttribute, model.Phone);
                    if (_customerSettings.FaxEnabled)
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.FaxAttribute, model.Fax);
                    ...
                    _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.CustomCustomerAttributes, customerAttributesXml);
                    ...
                    {
                        FirstName = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.FirstNameAttribute),
                        LastName = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.LastNameAttribute),
                        Email = customer.Email,
                        Company = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.CompanyAttribute),
                        CountryId = _genericAttributeService.GetAttribute<int>(customer, GSCustomerDefaults.CountryIdAttribute) > 0
                            ? (int?)_genericAttributeService.GetAttribute<int>(customer, GSCustomerDefaults.CountryIdAttribute)
                            : null,
                        StateProvinceId = _genericAttributeService.GetAttribute<int>(customer, GSCustomerDefaults.StateProvinceIdAttribute) > 0
                            ? (int?)_genericAttributeService.GetAttribute<int>(customer, GSCustomerDefaults.StateProvinceIdAttribute)
                            : null,
                        County = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.CountyAttribute),
                        City = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.CityAttribute),
                        Address1 = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.StreetAddressAttribute),
                        Address2 = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.StreetAddress2Attribute),
                        ZipPostalCode = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.ZipPostalCodeAttribute),
                        PhoneNumber = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.PhoneAttribute),
                        FaxNumber = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.FaxAttribute),
                        ...
                        case UserRegistrationType.EmailValidation:
                            {
                                ...
                                _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.AccountActivationTokenAttribute, Guid.NewGuid().ToString());
        ...
        public virtual IActionResult AccountActivation(string token, string email)
        {
            ...
            var cToken = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.AccountActivationTokenAttribute);
            ...
            _customerService.UpdateCustomer(customer);
            _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.AccountActivationTokenAttribute, "");
        ...
        public virtual IActionResult Info(CustomerInfoModel model)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (_dateTimeSettings.AllowCustomersToSetTimeZone)
                    {
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.TimeZoneIdAttribute,
                            model.TimeZoneId);
                    }
                    ...
                    if (_customerSettings.CountryEnabled)
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.CountryIdAttribute, model.CountryId);
                    if (_customerSettings.CountryEnabled && _customerSettings.StateProvinceEnabled)
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.StateProvinceIdAttribute, model.StateProvinceId);
                    if (_customerSettings.PhoneEnabled)
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.PhoneAttribute, model.Phone);
                    if (_customerSettings.FaxEnabled)
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.FaxAttribute, model.Fax);
                    ...
                    if (_forumSettings.ForumsEnabled && _forumSettings.SignaturesEnabled)
                        _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.SignatureAttribute, model.Signature);

                    //save customer attributes
                    _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                        GSCustomerDefaults.CustomCustomerAttributes, customerAttributesXml);
        ...
        public virtual IActionResult EmailRevalidation(string token, string email)
        {
            ...
            var cToken = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.EmailRevalidationTokenAttribute);
            if (string.IsNullOrEmpty(cToken))
            ...
            _customerService.UpdateCustomer(customer);
            _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.EmailRevalidationTokenAttribute, "");
        ...
        public virtual IActionResult ChangePassword(ChangePasswordModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                foreach (var error in changePasswordResult.Errors)
                    ErrorNotification(_localizationService.GetResource(error));
                //ModelState.AddModelError("", error);
                return View(model);
            }
        ...
        [HttpsRequirement(SslRequirement.Yes)]
        public virtual IActionResult Avatar(Guid customerGuid)
        {
            if (!_workContext.CurrentCustomer.IsRegistered())
                return Challenge();
            ...
            model = _customerModelFactory.PrepareCustomerAvatarModel(model, customer);
            return View(model);
        }
        ...
        public virtual IActionResult UploadAvatar(CustomerAvatarModel model, IFormFile uploadedFile)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    var customerAvatar = _pictureService.GetPictureById(_genericAttributeService.GetAttribute<int>(customer, GSCustomerDefaults.AvatarPictureIdAttribute));
                    if (uploadedFile != null && !string.IsNullOrEmpty(uploadedFile.FileName))
                    {
                        var avatarMaxSize = _customerSettings.AvatarMaximumSizeBytes;
                        if (uploadedFile.Length > avatarMaxSize)
                            throw new GSException(string.Format(_localizationService.GetResource("Account.Avatar.MaximumUploadedFileSize"), avatarMaxSize));
                    ...
                    _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.AvatarPictureIdAttribute, customerAvatarId);
        ...
        public virtual IActionResult RemoveAvatar(CustomerAvatarModel model)
        {
            ...
            _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.AvatarPictureIdAttribute, 0);
        ...
        public virtual IActionResult SearchCustomer(string Name,int UnitId =0 )
        {
            var items = _customerService.GetAllCustomers(username:Name,UnitId: UnitId);
            return Json(items.Select(c =>
            {
                var m = c.ToModel<CustomerModel>();
                return m;
            }
            ).ToList());
        }
        public virtual IActionResult SearchCustomerList(CustomerUnitSearchModel searchModel)
        {
            if (searchModel.UnitId > 0)
            {
                searchModel.SelectedUnitIds.Add(searchModel.UnitId);
            }
            var items = _customerService.GetSearchAllCustomer(Keyword: searchModel.srKeywordCustomer,SelectedUnitIds: searchModel.SelectedUnitIds);           
            return Json(items.Select(c =>
            {
                var m = _customerModelFactory.PrepareCustomerList(c);
                return m;
            }
            ).ToList());
        }
        public virtual IActionResult SearchCustomerPageList(CustomerSearchModel searchModel)
        {
            var model = _customerModelFactory.PrepareCustomerSearchList(searchModel);
            return Json(model);
        }
        #endregion
