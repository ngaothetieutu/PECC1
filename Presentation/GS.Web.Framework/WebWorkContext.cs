    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        public virtual Customer CurrentCustomer
        {
            get
            {
                ...
                if (_httpContextAccessor.HttpContext == null ||
                    _httpContextAccessor.HttpContext.Request.Path.Equals(new PathString($"/{GSTaskDefaults.ScheduleTaskPath}"), StringComparison.InvariantCultureIgnoreCase))
                {
                    //in this case return built-in customer record for background task
                    customer = _customerService.GetCustomerBySystemName(GSCustomerDefaults.BackgroundTaskCustomerName);
                }
                ...
                if (customer == null || customer.Deleted || !customer.Active || customer.RequireReLogin)
                {
                    ...
                    if (_userAgentHelper.IsSearchEngine())
                        customer = _customerService.GetCustomerBySystemName(GSCustomerDefaults.SearchEngineCustomerName);
                }
                ...
                if (customer != null && !customer.Deleted && customer.Active && !customer.RequireReLogin)
                {
                    ...
                    var impersonatedCustomerId = _genericAttributeService
                        .GetAttribute<int?>(customer, GSCustomerDefaults.ImpersonatedCustomerIdAttribute);
        ...
        public virtual Language WorkingLanguage
        {
            get
            {
                ...
                if (detectedLanguage == null && _localizationSettings.AutomaticallyDetectLanguage)
                {
                    ...
                    var alreadyDetected = _genericAttributeService.GetAttribute<bool>(this.CurrentCustomer,
                        GSCustomerDefaults.LanguageAutomaticallyDetectedAttribute, _storeContext.CurrentStore.Id);
                    ...
                    if (!alreadyDetected)
                    {
                        ...
                        if (detectedLanguage != null)
                        {
                            ...
                            _genericAttributeService.SaveAttribute(this.CurrentCustomer,
                                GSCustomerDefaults.LanguageAutomaticallyDetectedAttribute, true, _storeContext.CurrentStore.Id);
                        }
                    }
                }
                ...
                if (detectedLanguage != null)
                {
                    ...
                    var currentLanguageId = _genericAttributeService.GetAttribute<int>(this.CurrentCustomer,
                        GSCustomerDefaults.LanguageIdAttribute, _storeContext.CurrentStore.Id);

                    //save the detected language identifier if it differs from the current one
                    if (detectedLanguage.Id != currentLanguageId)
                    {
                        _genericAttributeService.SaveAttribute(this.CurrentCustomer,
                            GSCustomerDefaults.LanguageIdAttribute, detectedLanguage.Id, _storeContext.CurrentStore.Id);
                    }
                }
            ...
            set
            {
                ...
                //and save it
                _genericAttributeService.SaveAttribute(this.CurrentCustomer,
                    GSCustomerDefaults.LanguageIdAttribute, languageId, _storeContext.CurrentStore.Id);
        ...
        public virtual Currency WorkingCurrency
        {
            get
            {
                ...
                var customerCurrencyId = _genericAttributeService.GetAttribute<int>(this.CurrentCustomer,
                    GSCustomerDefaults.CurrencyIdAttribute, _storeContext.CurrentStore.Id);
            ...
            set
            {
                ...
                //and save it
                _genericAttributeService.SaveAttribute(this.CurrentCustomer,
                    GSCustomerDefaults.CurrencyIdAttribute, currencyId, _storeContext.CurrentStore.Id);
        ...
        public virtual TaxDisplayType TaxDisplayType
        {
            get
            {
                ...
                if (_taxSettings.AllowCustomersToSelectTaxDisplayType && this.CurrentCustomer != null)
                {
                    ...
                    var taxDisplayTypeId = _genericAttributeService.GetAttribute<int?>(this.CurrentCustomer,
                        GSCustomerDefaults.TaxDisplayTypeIdAttribute, _storeContext.CurrentStore.Id);
            ...
            set
            {
                ...
                //save passed value
                _genericAttributeService.SaveAttribute(this.CurrentCustomer,
                    GSCustomerDefaults.TaxDisplayTypeIdAttribute, (int)value, _storeContext.CurrentStore.Id);
