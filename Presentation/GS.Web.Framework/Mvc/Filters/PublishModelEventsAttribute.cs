    ...
    public class PublishModelEventsAttribute : TypeFilterAttribute
    {
        ...
        private class PublishModelEventsFilter : IActionFilter
        {
            ...
            public void OnActionExecuting(ActionExecutingContext context)
            {
                ...
                foreach (var model in context.ActionArguments.Values.OfType<BaseGSModel>())
                {
                    //we publish the ModelReceived event for all models as the BaseGSModel, 
                    //so you need to implement IConsumer<ModelReceived<BaseGSModel>> interface to handle this event
            ...
            public void OnActionExecuted(ActionExecutedContext context)
            {
                ...
                {
                    if (controller.ViewData.Model is BaseGSModel model)
                    {
                    ...
                    if (controller.ViewData.Model is IEnumerable<BaseGSModel> modelCollection)
                    {
