...
namespace GS.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        /// <summary>
        /// Gets Search All Customer
        /// </summary>
        /// <param name="lastActivityFromUtc">Keyword</param>
        /// <returns>Customers</returns>
        IPagedList<Customer> GetSearchAllCustomer(string Keyword = null, int[] ExcludeCustomerIds = null, int[] customerRoleIds = null,List<int> SelectedUnitIds = null, int pageIndex = 0, int pageSize = int.MaxValue);
        ...
        IList<CustomerRole> GetCustomerRolesByPrefix(string strPre);
        #endregion
