...
namespace GS.Services.Customers
{
    ...
    public partial class CustomerAttributeService : ICustomerAttributeService
    {
        ...
        public virtual void DeleteCustomerAttribute(CustomerAttribute customerAttribute)
        {
            ...
            _cacheManager.RemoveByPattern(GSCustomerServiceDefaults.CustomerAttributesPatternCacheKey);
            _cacheManager.RemoveByPattern(GSCustomerServiceDefaults.CustomerAttributeValuesPatternCacheKey);
        ...
        {
            return _cacheManager.Get(GSCustomerServiceDefaults.CustomerAttributesAllCacheKey, () =>
            {
        ...
        public virtual CustomerAttribute GetCustomerAttributeById(int customerAttributeId)
        {
            ...
            var key = string.Format(GSCustomerServiceDefaults.CustomerAttributesByIdCacheKey, customerAttributeId);
        ...
        {
            var key = string.Format(GSCustomerServiceDefaults.CustomerAttributeValuesAllCacheKey, customerAttributeId);
        ...
        public virtual CustomerAttributeValue GetCustomerAttributeValueById(int customerAttributeValueId)
        {
            ...
            var key = string.Format(GSCustomerServiceDefaults.CustomerAttributeValuesByIdCacheKey, customerAttributeValueId);
