    ...
    public partial class Task
    {
        ...
        private void ExecuteTask()
        {
            ...
            catch (Exception ex)
            {
                ...
                //throw new Exception($"Schedule task ({ScheduleTask.Type}) cannot resolve: "+ex.Message);
            }
            ...
            if (instance == null)
            {
                ...
                {
                    //try resolve
                    throw new Exception($"Schedule task ({ScheduleTask.Type}) cannot ResolveUnregistered: " + ex.Message);
                }
                //not resolved
