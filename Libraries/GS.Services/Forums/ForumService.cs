...
namespace GS.Services.Forums
{
    ...
    public partial class ForumService : IForumService
    {
        ...
        private void UpdateCustomerStats(int customerId)
        {
            ...
            _genericAttributeService.SaveAttribute(customer, GSCustomerDefaults.ForumPostCountAttribute, numPosts);
        }
        ...
        public virtual void DeleteForumGroup(ForumGroup forumGroup)
        {
            ...
            _cacheManager.RemoveByPattern(GSForumDefaults.ForumGroupPatternCacheKey);
            _cacheManager.RemoveByPattern(GSForumDefaults.ForumPatternCacheKey);
        ...
        {
            return _cacheManager.Get(GSForumDefaults.ForumGroupAllCacheKey, () =>
            {
        ...
        {
            var key = string.Format(GSForumDefaults.ForumAllByForumGroupIdCacheKey, forumGroupId);
        ...
        public virtual void InsertPrivateMessage(PrivateMessage privateMessage)
        {
            ...
            if (customerTo == null)
            {
                throw new GSException("Recipient could not be loaded");
            }

            //UI notification
            _genericAttributeService.SaveAttribute(customerTo, GSCustomerDefaults.NotifiedAboutNewPrivateMessagesAttribute, false, privateMessage.StoreId);
        ...
        public virtual string GetTopicSeName(ForumTopic forumTopic)
        {
            ...
            var maxLength = GSSeoDefaults.ForumTopicLength;
