namespace GS.Services.Media
{
    ...
    /// </summary>
    public static partial class GSMediaDefaults
    {
        /// <summary>
        ...
        /// {0} : thumb file name
        /// </remarks>
        public static string ThumbExistsCacheKey => "GS.azure.thumb.exists-{0}";

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string ThumbsPatternCacheKey => "GS.azure.thumb";
