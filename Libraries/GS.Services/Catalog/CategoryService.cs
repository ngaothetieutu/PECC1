...
namespace GS.Services.Catalog
{
    ...
    public partial class CategoryService : ICategoryService
    {
        ...
        public virtual IList<Category> GetAllCategories(int storeId = 0, bool showHidden = false, bool loadCacheableCopy = true)
        {
            ...
            {
                //cacheable copy
                var key = string.Format(GSCatalogDefaults.CategoriesAllCacheKey,
                    storeId,
        ...
        {
            var key = string.Format(GSCatalogDefaults.CategoriesByParentCategoryIdCacheKey, parentCategoryId, showHidden, _workContext.CurrentCustomer.Id, _storeContext.CurrentStore.Id);
        ...
        {
            var cacheKey = string.Format(GSCatalogDefaults.CategoriesChildIdentifiersCacheKey,
                parentCategoryId,
                string.Join(",", _workContext.CurrentCustomer.GetCustomerRoleIds()),
        ...
        public virtual Category GetCategoryById(int categoryId)
        {
            ...
            var key = string.Format(GSCatalogDefaults.CategoriesByIdCacheKey, categoryId);
        ...
        //    var key = string.Format(GSCatalogDefaults.ProductCategoriesAllByCategoryIdCacheKey, showHidden, categoryId, pageIndex, pageSize, _workContext.CurrentCustomer.Id, _storeContext.CurrentStore.Id);
        //    return _cacheManager.Get(key, () =>
        //    {
        ...
        //    var key = string.Format(GSCatalogDefaults.ProductCategoriesAllByProductIdCacheKey, showHidden, productId, _workContext.CurrentCustomer.Id, storeId);
        //    return _cacheManager.Get(key, () =>
        //    {
        //        var query = from pc in _productCategoryRepository.Table
        //                    join c in _categoryRepository.Table on pc.CategoryId equals c.Id
