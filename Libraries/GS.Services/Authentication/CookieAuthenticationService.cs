    ...
    public partial class CookieAuthenticationService : IAuthenticationService
    {
        ...
        public virtual async void SignIn(Customer customer, bool isPersistent)
        {
            ...
            if (!string.IsNullOrEmpty(customer.Username))
                claims.Add(new Claim(ClaimTypes.Name, customer.Username, ClaimValueTypes.String, GSAuthenticationDefaults.ClaimsIssuer));

            if (!string.IsNullOrEmpty(customer.Email))
                claims.Add(new Claim(ClaimTypes.Email, customer.Email, ClaimValueTypes.Email, GSAuthenticationDefaults.ClaimsIssuer));
