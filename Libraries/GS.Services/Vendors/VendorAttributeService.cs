...
namespace GS.Services.Vendors
{
    ...
    public partial class VendorAttributeService : IVendorAttributeService
    {
        ...
        {
            return _cacheManager.Get(GSVendorsServiceDefaults.VendorAttributesAllCacheKey, () =>
            {
        ...
        public virtual VendorAttribute GetVendorAttributeById(int vendorAttributeId)
        {
            ...
            var key = string.Format(GSVendorsServiceDefaults.VendorAttributesByIdCacheKey, vendorAttributeId);
        ...
        {
            var key = string.Format(GSVendorsServiceDefaults.VendorAttributeValuesAllCacheKey, vendorAttributeId);
        ...
        public virtual VendorAttributeValue GetVendorAttributeValueById(int vendorAttributeValueId)
        {
            ...
            var key = string.Format(GSVendorsServiceDefaults.VendorAttributeValuesByIdCacheKey, vendorAttributeValueId);
