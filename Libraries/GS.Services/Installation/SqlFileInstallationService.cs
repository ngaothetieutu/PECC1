...
namespace GS.Services.Installation
{
    ...
    public partial class SqlFileInstallationService : IInstallationService
    {
        ...
        {
            ExecuteSqlFile(_fileProvider.MapPath(GSInstallationDefaults.RequiredDataPath));
            ...
            {
                ExecuteSqlFile(_fileProvider.MapPath(GSInstallationDefaults.SampleDataPath));
            }
        }
