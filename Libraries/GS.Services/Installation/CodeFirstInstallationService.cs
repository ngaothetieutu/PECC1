...
//namespace GS.Services.Installation
//{
//    /// <summary>
...
//            //max length
//            name = CommonHelper.EnsureMaximumLength(name, GSSeoDefaults.SearchEngineNameLength);
...
//        {
//            return _fileProvider.GetAbsolutePath(GSInstallationDefaults.SampleImagesPath);
//        }
...
//                Active = true,
//                IsSystemRole = true,
//                SystemName = GSCustomerDefaults.AdministratorsRoleName
//            };
...
//                Active = true,
//                IsSystemRole = true,
//                SystemName = GSCustomerDefaults.ForumModeratorsRoleName
//            };
...
//                Active = true,
//                IsSystemRole = true,
//                SystemName = GSCustomerDefaults.RegisteredRoleName
//            };
...
//                Active = true,
//                IsSystemRole = true,
//                SystemName = GSCustomerDefaults.GuestsRoleName
//            };
...
//                Active = true,
//                IsSystemRole = true,
//                SystemName = GSCustomerDefaults.VendorsRoleName
//            };
...
//            _genericAttributeService.SaveAttribute(adminUser, GSCustomerDefaults.FirstNameAttribute, "John");
//            _genericAttributeService.SaveAttribute(adminUser, GSCustomerDefaults.LastNameAttribute, "Smith");
...
//            //set default customer name
//            _genericAttributeService.SaveAttribute(secondUser, GSCustomerDefaults.FirstNameAttribute, defaultSecondUserAddress.FirstName);
//            _genericAttributeService.SaveAttribute(secondUser, GSCustomerDefaults.LastNameAttribute, defaultSecondUserAddress.LastName);
...
//            //set default customer name
//            _genericAttributeService.SaveAttribute(thirdUser, GSCustomerDefaults.FirstNameAttribute, defaultThirdUserAddress.FirstName);
//            _genericAttributeService.SaveAttribute(thirdUser, GSCustomerDefaults.LastNameAttribute, defaultThirdUserAddress.LastName);
...
//            //set default customer name
//            _genericAttributeService.SaveAttribute(fourthUser, GSCustomerDefaults.FirstNameAttribute, defaultFourthUserAddress.FirstName);
//            _genericAttributeService.SaveAttribute(fourthUser, GSCustomerDefaults.LastNameAttribute, defaultFourthUserAddress.LastName);
...
//            //set default customer name
//            _genericAttributeService.SaveAttribute(fifthUser, GSCustomerDefaults.FirstNameAttribute, defaultFifthUserAddress.FirstName);
//            _genericAttributeService.SaveAttribute(fifthUser, GSCustomerDefaults.LastNameAttribute, defaultFifthUserAddress.LastName);
...
//            //set default customer name
//            _genericAttributeService.SaveAttribute(sixthUser, GSCustomerDefaults.FirstNameAttribute, defaultSixthUserAddress.FirstName);
//            _genericAttributeService.SaveAttribute(sixthUser, GSCustomerDefaults.LastNameAttribute, defaultSixthUserAddress.LastName);
...
//                SystemName = GSCustomerDefaults.SearchEngineCustomerName,
//                CreatedOnUtc = DateTime.UtcNow,
//                LastActivityDateUtc = DateTime.UtcNow,
//                RegisteredInStoreId = storeId
//            };
...
//                Active = true,
//                IsSystemAccount = true,
//                SystemName = GSCustomerDefaults.BackgroundTaskCustomerName,
//                CreatedOnUtc = DateTime.UtcNow,
//                LastActivityDateUtc = DateTime.UtcNow,
//                RegisteredInStoreId = storeId
//            };
...
//                SupportPreviousGScommerceVersions = true,
...
//                    Name = "Send emails",
//                    Seconds = 60,
//                    Type = "GS.Services.Messages.QueuedMessagesSendTask, GS.Services",
//                    Enabled = true,
//                    StopOnError = false
//                },
//                new ScheduleTask
...
//                    Name = "Keep alive",
//                    Seconds = 300,
//                    Type = "GS.Services.Common.KeepAliveTask, GS.Services",
//                    Enabled = true,
//                    StopOnError = false
//                },
//                new ScheduleTask
...
//                    Name = "Delete guests",
//                    Seconds = 600,
//                    Type = "GS.Services.Customers.DeleteGuestsTask, GS.Services",
//                    Enabled = true,
//                    StopOnError = false
//                },
//                new ScheduleTask
...
//                    Name = "Clear cache",
//                    Seconds = 600,
//                    Type = "GS.Services.Caching.ClearCacheTask, GS.Services",
//                    Enabled = false,
//                    StopOnError = false
//                },
//                new ScheduleTask
...
//                    //60 minutes
//                    Seconds = 3600,
//                    Type = "GS.Services.Logging.ClearLogTask, GS.Services",
//                    Enabled = false,
//                    StopOnError = false
//                },
//                new ScheduleTask
...
//                    //60 minutes
//                    Seconds = 3600,
//                    Type = "GS.Services.Directory.UpdateExchangeRateTask, GS.Services",
//                    Enabled = true,
//                    StopOnError = false
//                }
//            };
