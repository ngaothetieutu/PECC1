...
namespace GS.Services.Security
{
    ...
    public partial class PermissionService : IPermissionService
    {
        ...
        {
            var key = string.Format(GSSecurityDefaults.PermissionsAllByCustomerRoleIdCacheKey, customerRoleId);
        ...
        protected virtual bool Authorize(string permissionRecordSystemName, int customerRoleId)
        {
            ...
            var key = string.Format(GSSecurityDefaults.PermissionsAllowedCacheKey, customerRoleId, permissionRecordSystemName);
        ...
        public virtual void DeletePermissionRecord(PermissionRecord permission)
        {
            ...
            _cacheManager.RemoveByPattern(GSSecurityDefaults.PermissionsPatternCacheKey);
