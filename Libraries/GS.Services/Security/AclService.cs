...
namespace GS.Services.Security
{
    ...
    public partial class AclService : IAclService
    {
        ...
        public virtual void DeleteAclRecord(AclRecord aclRecord)
        {
            ...
            //cache
            _cacheManager.RemoveByPattern(GSSecurityDefaults.AclRecordPatternCacheKey);
        ...
        public virtual int[] GetCustomerRoleIdsWithAccess<T>(T entity) where T : BaseEntity, IAclSupported
        {
            ...
            var key = string.Format(GSSecurityDefaults.AclRecordByEntityIdNameCacheKey, entityId, entityName);
