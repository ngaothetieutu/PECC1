...
namespace GS.Services.Directory
{
    ...
    public partial class StateProvinceService : IStateProvinceService
    {
        ...
        public virtual void DeleteStateProvince(StateProvince stateProvince)
        {
            ...
            _cacheManager.RemoveByPattern(GSDirectoryDefaults.StateProvincesPatternCacheKey);
        ...
        {
            var key = string.Format(GSDirectoryDefaults.StateProvincesAllCacheKey, countryId, languageId, showHidden);
