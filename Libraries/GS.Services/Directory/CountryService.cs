...
namespace GS.Services.Directory
{
    ...
    public partial class CountryService : ICountryService
    {
        ...
        public virtual void DeleteCountry(Country country)
        {
            ...
            _cacheManager.RemoveByPattern(GSDirectoryDefaults.CountriesPatternCacheKey);
        ...
        {
            var key = string.Format(GSDirectoryDefaults.CountriesAllCacheKey, languageId, showHidden);
