...
namespace GS.Services.Directory
{
    ...
    public partial class MeasureService : IMeasureService
    {
        ...
        public virtual void DeleteMeasureDimension(MeasureDimension measureDimension)
        {
            ...
            _cacheManager.RemoveByPattern(GSDirectoryDefaults.MeasureDimensionsPatternCacheKey);
        ...
        public virtual MeasureDimension GetMeasureDimensionById(int measureDimensionId)
        {
            ...
            var key = string.Format(GSDirectoryDefaults.MeasureDimensionsByIdCacheKey, measureDimensionId);
        ...
        {
            return _cacheManager.Get(GSDirectoryDefaults.MeasureDimensionsAllCacheKey, () =>
            {
            ...
            MeasureDimension sourceMeasureDimension)
        {
            ...
            if (exchangeRatio == decimal.Zero)
                throw new GSException($"Exchange ratio not set for dimension [{sourceMeasureDimension.Name}]");
            ...
            MeasureDimension targetMeasureDimension)
        {
            ...
            if (exchangeRatio == decimal.Zero)
                throw new GSException($"Exchange ratio not set for dimension [{targetMeasureDimension.Name}]");
            result = result * exchangeRatio;
        ...
        public virtual void DeleteMeasureWeight(MeasureWeight measureWeight)
        {
            ...
            _cacheManager.RemoveByPattern(GSDirectoryDefaults.MeasureWeightsPatternCacheKey);
        ...
        public virtual MeasureWeight GetMeasureWeightById(int measureWeightId)
        {
            ...
            var key = string.Format(GSDirectoryDefaults.MeasureWeightsByIdCacheKey, measureWeightId);
        ...
        {
            return _cacheManager.Get(GSDirectoryDefaults.MeasureWeightsAllCacheKey, () =>
            {
        ...
        public virtual decimal ConvertToPrimaryMeasureWeight(decimal value, MeasureWeight sourceMeasureWeight)
        {
            ...
            if (exchangeRatio == decimal.Zero)
                throw new GSException($"Exchange ratio not set for weight [{sourceMeasureWeight.Name}]");
            result = result / exchangeRatio;
            ...
            MeasureWeight targetMeasureWeight)
        {
            ...
            if (exchangeRatio == decimal.Zero)
                throw new GSException($"Exchange ratio not set for weight [{targetMeasureWeight.Name}]");
            result = result * exchangeRatio;
