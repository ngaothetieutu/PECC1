...
namespace GS.Services.Stores
{
    ...
    public partial class StoreService : IStoreService
    {
        ...
        public virtual void DeleteStore(Store store)
        {
            ...
            _cacheManager.RemoveByPattern(GSStoreDefaults.StoresPatternCacheKey);
        ...
        public virtual IList<Store> GetAllStores(bool loadCacheableCopy = true)
        {
            ...
            {
                //cacheable copy
                return _cacheManager.Get(GSStoreDefaults.StoresAllCacheKey, () =>
                {
        ...
        public virtual Store GetStoreById(int storeId, bool loadCacheableCopy = true)
        {
            ...
            //cacheable copy
            var key = string.Format(GSStoreDefaults.StoresByIdCacheKey, storeId);
