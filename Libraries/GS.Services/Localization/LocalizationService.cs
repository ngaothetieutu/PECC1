...
namespace GS.Services.Localization
{
    ...
    public partial class LocalizationService : ILocalizationService
    {
        ...
        {
            var key = string.Format(GSLocalizationDefaults.LocaleStringResourcesAllCacheKey, languageId);
            ...
            if (!loadPublicLocales.HasValue || _cacheManager.IsSet(key))
            {
                ...
                _cacheManager.Remove(string.Format(GSLocalizationDefaults.LocaleStringResourcesAllPublicCacheKey, languageId));
                _cacheManager.Remove(string.Format(GSLocalizationDefaults.LocaleStringResourcesAllAdminCacheKey, languageId));

                return rez;
            }

            //performance optimization of the site startup
            key = string.Format(loadPublicLocales.Value ? GSLocalizationDefaults.LocaleStringResourcesAllPublicCacheKey : GSLocalizationDefaults.LocaleStringResourcesAllAdminCacheKey, languageId);
            ...
            return _cacheManager.Get(key, () =>
            {
                ...
                var query = from l in _lsrRepository.TableNoTracking
                            ...
                            where l.LanguageId == languageId
                            select l;
                query = loadPublicLocales.Value ? query.Where(r => !r.ResourceName.StartsWith(GSLocalizationDefaults.AdminLocaleStringResourcesPrefix)) : query.Where(r => r.ResourceName.StartsWith(GSLocalizationDefaults.AdminLocaleStringResourcesPrefix));
                return ResourceValuesToDictionary(query);
            });
        }
            ...
            bool logIfNotFound = true, string defaultValue = "", bool returnEmptyIfNotFound = false)
        {
            ...
            if (_localizationSettings.LoadAllLocaleRecordsOnStartup)
            {
                ...
                var resources = GetAllResourceValues(languageId, !resourceKey.StartsWith(GSLocalizationDefaults.AdminLocaleStringResourcesPrefix, StringComparison.InvariantCultureIgnoreCase));
            ...
            {
                //gradual loading
                var key = string.Format(GSLocalizationDefaults.LocaleStringResourcesByResourceNameCacheKey, languageId, resourceKey);
        ...
        public virtual string ExportResourcesToXml(Language language)
        {
            ...
            xmlWriter.WriteAttributeString("SupportedVersion", GSVersion.CurrentVersion);
        ...
        public virtual string GetLocalizedEnum<TEnum>(TEnum enumValue, int? languageId = null) where TEnum : struct
        {
            ...
            //localized value
            var resourceName = $"{GSLocalizationDefaults.EnumLocaleStringResourcesPrefix}{typeof(TEnum)}.{enumValue}";
        ...
        public virtual string GetLocalizedPermissionName(PermissionRecord permissionRecord, int? languageId = null)
        {
            ...
            //localized value
            var resourceName = $"{GSLocalizationDefaults.PermissionLocaleStringResourcesPrefix}{permissionRecord.SystemName}";
            var result = GetResource(resourceName, languageId ?? _workContext.WorkingLanguage.Id, false, string.Empty, true);
            ...
            where TPlugin : IPlugin
        {
            ...
            //localized value
            var resourceName = $"{GSLocalizationDefaults.PluginNameLocaleStringResourcesPrefix}{systemName}";
