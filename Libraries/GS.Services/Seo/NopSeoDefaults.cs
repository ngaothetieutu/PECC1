namespace GS.Services.Seo
{
    ...
    /// </summary>
    public static partial class GSSeoDefaults
    {
        /// <summary>
        ...
        /// {2} : language ID
        /// </remarks>
        public static string UrlRecordActiveByIdNameLanguageCacheKey => "GS.urlrecord.active.id-name-language-{0}-{1}-{2}";

        /// <summary>
        /// Gets a key for caching
        /// </summary>
        public static string UrlRecordAllCacheKey => "GS.urlrecord.all";
        ...
        /// {0} : slug
        /// </remarks>
        public static string UrlRecordBySlugCacheKey => "GS.urlrecord.active.slug-{0}";

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string UrlRecordPatternCacheKey => "GS.urlrecord.";
