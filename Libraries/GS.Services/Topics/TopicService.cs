...
namespace GS.Services.Topics
{
    ...
    public partial class TopicService : ITopicService
    {
        ...
        public virtual void DeleteTopic(Topic topic)
        {
            ...
            //cache
            _cacheManager.RemoveByPattern(GSTopicDefaults.TopicsPatternCacheKey);
        ...
        public virtual Topic GetTopicById(int topicId)
        {
            ...
            var key = string.Format(GSTopicDefaults.TopicsByIdCacheKey, topicId);
        ...
        {
            var key = string.Format(GSTopicDefaults.TopicsAllCacheKey, storeId, ignorAcl, showHidden);
