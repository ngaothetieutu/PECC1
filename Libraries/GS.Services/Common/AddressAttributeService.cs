...
namespace GS.Services.Common
{
    ...
    public partial class AddressAttributeService : IAddressAttributeService
    {
        ...
        public virtual void DeleteAddressAttribute(AddressAttribute addressAttribute)
        {
            ...
            _cacheManager.RemoveByPattern(GSCommonDefaults.AddressAttributesPatternCacheKey);
            _cacheManager.RemoveByPattern(GSCommonDefaults.AddressAttributeValuesPatternCacheKey);
        ...
        {
            return _cacheManager.Get(GSCommonDefaults.AddressAttributesAllCacheKey, () =>
            {
        ...
        public virtual AddressAttribute GetAddressAttributeById(int addressAttributeId)
        {
            ...
            var key = string.Format(GSCommonDefaults.AddressAttributesByIdCacheKey, addressAttributeId);
        ...
        {
            var key = string.Format(GSCommonDefaults.AddressAttributeValuesAllCacheKey, addressAttributeId);
        ...
        public virtual AddressAttributeValue GetAddressAttributeValueById(int addressAttributeValueId)
        {
            ...
            var key = string.Format(GSCommonDefaults.AddressAttributeValuesByIdCacheKey, addressAttributeValueId);
