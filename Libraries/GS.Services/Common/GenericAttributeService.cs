...
namespace GS.Services.Common
{
    ...
    public partial class GenericAttributeService : IGenericAttributeService
    {
        ...
        public virtual void DeleteAttribute(GenericAttribute attribute)
        {
            ...
            //cache
            _cacheManager.RemoveByPattern(GSCommonDefaults.GenericAttributePatternCacheKey);
        ...
        {
            var key = string.Format(GSCommonDefaults.GenericAttributeCacheKey, entityId, keyGroup);
