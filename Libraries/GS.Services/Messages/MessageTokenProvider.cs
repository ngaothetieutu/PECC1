...
namespace GS.Services.Messages
{
    ...
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        public virtual void AddCustomerTokens(IList<Token> tokens, Customer customer)
        {
            ...
            tokens.Add(new Token("Customer.FirstName", _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.FirstNameAttribute)));
            tokens.Add(new Token("Customer.LastName", _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.LastNameAttribute)));
            tokens.Add(new Token("Customer.VatNumber", _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.VatNumberAttribute)));
            tokens.Add(new Token("Customer.VatNumberStatus", ((VatNumberStatus)_genericAttributeService.GetAttribute<int>(customer, GSCustomerDefaults.VatNumberStatusIdAttribute)).ToString()));

            var customAttributesXml = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.CustomCustomerAttributes);
            ...
            var passwordRecoveryUrl = RouteUrl(routeName: "PasswordRecoveryConfirm", routeValues: new { token = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.PasswordRecoveryTokenAttribute), email = customer.Email });
            var accountActivationUrl = RouteUrl(routeName: "AccountActivation", routeValues: new { token = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.AccountActivationTokenAttribute), email = customer.Email });
            var emailRevalidationUrl = RouteUrl(routeName: "EmailRevalidation", routeValues: new { token = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.EmailRevalidationTokenAttribute), email = customer.Email });
        ...
        public virtual void AddVendorTokens(IList<Token> tokens, Vendor vendor)
        {
            ...
            var vendorAttributesXml = _genericAttributeService.GetAttribute<string>(vendor, GSVendorDefaults.VendorAttributes);
