...
namespace GS.Services.Messages
{
    ...
    public partial class MessageTemplateService : IMessageTemplateService
    {
        ...
        public virtual void DeleteMessageTemplate(MessageTemplate messageTemplate)
        {
            ...
            _cacheManager.RemoveByPattern(GSMessageDefaults.MessageTemplatesPatternCacheKey);
        ...
        public virtual IList<MessageTemplate> GetMessageTemplatesByName(string messageTemplateName, int? storeId = null)
        {
            ...
            var key = string.Format(GSMessageDefaults.MessageTemplatesByNameCacheKey, messageTemplateName, storeId ?? 0);
        ...
        {
            var key = string.Format(GSMessageDefaults.MessageTemplatesAllCacheKey, storeId);
            return _cacheManager.Get(key, () =>
            {
