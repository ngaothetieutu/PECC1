...
namespace GS.Data.Mapping.Customers
{
    ...
    /// </summary>
    public partial class CustomerCustomerRoleMap : GSEntityTypeConfiguration<CustomerCustomerRoleMapping>
    {
        #region Methods
        ...
        {
            builder.ToTable(GSMappingDefaults.CustomerCustomerRoleTable);
