...
namespace GS.Data.Mapping.Security
{
    /// <summary>
    /// Represents a permission record-customer role mapping configuration
    /// </summary>
    public partial class PermissionRecordCustomerRoleMap : GSEntityTypeConfiguration<PermissionRecordCustomerRoleMapping>
    {
        #region Methods
        ...
        {
            builder.ToTable(GSMappingDefaults.PermissionRecordRoleTable);
