...
namespace GS.Core.Domain.Customers
{
    ...
    public partial class Customer : BaseEntity
    {
        ...
        private ICollection<CustomerUnitMapping> _customerUnitMappings;
        ...
        /// <summary>
        /// Gets or sets customer-unit mappings
        /// </summary>
        public virtual ICollection<CustomerUnitMapping> CustomerUnitMappings
        {
            get => _customerUnitMappings ?? (_customerUnitMappings = new List<CustomerUnitMapping>());
            protected set => _customerUnitMappings = value;
        }
        /// <summary>
