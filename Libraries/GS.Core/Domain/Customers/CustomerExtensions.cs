...
namespace GS.Core.Domain.Customers
{
    ...
    public static class CustomerExtensions
    {
        ...
        public static bool IsSearchEngineAccount(this Customer customer)
        {
            ...
            var result = customer.SystemName.Equals(GSCustomerDefaults.SearchEngineCustomerName, StringComparison.InvariantCultureIgnoreCase);
            return result;
        }
        ...
        public static bool IsBackgroundTaskAccount(this Customer customer)
        {
            ...
            var result = customer.SystemName.Equals(GSCustomerDefaults.BackgroundTaskCustomerName, StringComparison.InvariantCultureIgnoreCase);
            return result;
        }
        ...
        {
            return IsInCustomerRole(customer, GSCustomerDefaults.AdministratorsRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, GSCustomerDefaults.ForumModeratorsRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, GSCustomerDefaults.RegisteredRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, GSCustomerDefaults.GuestsRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, GSCustomerDefaults.VendorsRoleName, onlyActiveCustomerRoles);
        }
