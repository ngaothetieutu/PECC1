namespace GS.Core.Configuration
{
    ...
    public partial class GSConfig
    {
        ...
        /// <summary>
        /// gia tri mac dinh ty le khoan
        /// </summary>
        public decimal TaskGroupValueDefault { get; set; }
        public decimal TaxPercentDefault { get; set; }
        public decimal TaskGroupCostDefault { get; set; }
        public decimal TaskGroupSalaryDefault { get; set; }
    }
}