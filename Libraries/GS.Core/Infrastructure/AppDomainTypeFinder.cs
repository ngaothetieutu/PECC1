...
{
    /// <summary>
    /// A class that finds types needed by GS by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected IGSFileProvider _fileProvider;
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into GS.
        /// </returns>
        ...
        /// <summary>Gets or sets whether GS should iterate assemblies in the app domain when loading GS types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that GS assemblies aren't investigated (e.g. by not including something like "^GS|..." you may break core functionality.</remarks>
