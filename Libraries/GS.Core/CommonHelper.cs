...
namespace GS.Core
{
    public static class CommonExtention
    {
        ...
        public static string toCode(this int Id,int len=11)
        {
        ...
        private static string[] VietNamChar = new string[]
    {
        ...
        /// <param name="val"></param>
        /// <returns></returns>
        public static string ToStatusContractVN(this int val)
        {
            string valReturn = "";
            switch (val)
            {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    valReturn = "Đang thực hiện";
                    break;
                case 6:
                    valReturn = "Đã thanh lý";
                    break;
                case 7:
                    valReturn = "Kết thúc";
                    break;
                case 8:
                    valReturn = "Đã quyết toán";
                    break;
                case 9:
                    valReturn = "Nghiệm thu khối lượng";
                    break;
            }
            return valReturn;
        }
        public static string ToStatusTaskVN(this int val)
        {
            string valReturn = "";
            switch (val)
            {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    valReturn = "Hoàn thành";
                    break;
                case 7:
                    valReturn = "Đã quyết toán";
                    break;
                case 8:
                    valReturn = "Đã nghiệm thu khối lượng";
                    break;
            }
            return valReturn;
        }
